...
All API requests require authentication using an API key in the header, and your organizational identifier (org_id) in the request body.:

```bash
Authorization: Bearer YOUR_API_KEY
```

Get your API keys and org_id from the [Hindsight dashboard](https://app.usehindsight.com/settings/keys).
...
```json
{
  "document": {
    ...
    "file_name": "Competitor X Pricing Guide.pdf",
    "status": "processing",
    "url": "https://app.usehindsight.com/library/doc_abc123",
...
```json
{
  "document": {
    ...
    "status": "processing",
    "deal_id": "deal_123",
    "url": "https://app.usehindsight.com/deals/deal_123/documents/doc_def456",
    "created_at": "2026-02-10T12:00:00Z"
  },
...
```json
{
  ...
  "battlecard_url": "https://app.usehindsight.com/competitors/comp_123/battlecard"
}
```
  ...
  "documents": [
    {
      ...
      "url": "https://app.usehindsight.com/assets/doc_123"
    }
  ]
}
```
