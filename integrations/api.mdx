...
POST /api/v1/webhooks
{
  ...
  "events": ["deal.updated", "document.uploaded", "insight.generated"]
}
```

**Event Types:**
- `deal.updated` - Deal status or metadata changed
- `document.uploaded` - New document processed
- `insight.generated` - New AI-generated insight
- `competitor.updated` - Competitor intel updated
