...
1. **REST API** - Hindsight's AI handles multiple tool calls and returns a complete, cited text response
2. **[Model Context Protocol (MCP)](/integrations/mcp)** - Individual tools your AI assistant orchestrates directly

This page covers the REST API. For the tool-by-tool surface, see the [MCP docs](/integrations/mcp).

### When to Use Each

- **REST API**: For Glean, Slack bots, and search interfaces that want a finished, synthesized answer
