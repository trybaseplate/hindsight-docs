...
<Tabs>
  <Tab title="Claude">
    ...
    When you open the file, Claude Desktop will show an installation dialog where you can review the integration and enter your Hindsight API key.

    <Note>
      During the beta period, users will have to authenticate using a Hindsight API key on a per user basis.
    </Note>
  ...
  <Tab title="OpenAI / ChatGPT">
    ...
    **2. Create a Hindsight app**
    ...
    4. Set authentication to your API key
