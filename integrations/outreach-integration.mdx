...
Review the permissions and data-handling settings for both Hindsight and the connected S3 bucket before enabling this integration. For current security information, contact Hindsight support.
