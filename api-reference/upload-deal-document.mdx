...
```text
POST https://app.usehindsight.com/api/v1/documents/deals
...
<RequestExample>
```bash cURL
curl -X POST https://app.usehindsight.com/api/v1/documents/deals \
...
```javascript Node.js
const response = await fetch('https://app.usehindsight.com/api/v1/documents/deals', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://app.usehindsight.com/api/v1/documents/deals',
    headers={
