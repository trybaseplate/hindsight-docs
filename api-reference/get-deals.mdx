...
Rate limits: Organization-wide and per-API-key limits apply.
```
</Accordion>
...
| **Rate Limits** | Organization-wide and per-key limits | Organization-wide and per-key limits; exports may consume a separate usage quota |
