...
description: "Create portable skills and recurring workflows on top of Hindsight"
---
...
<CardGroup cols={2}>
  <Card title="Skills and Workflows" icon="wand-magic-sparkles" href="/guides/recipes">
    Build portable AI instructions that can be selected by name or loaded dynamically, then schedule prompts that need to run on a cadence.
  </Card>
...
Skills package a working set of instructions so people and AI tools can reliably perform the same task. Write them in portable language: a skill can work in Hindsight, Claude, or another AI tool. In Hindsight, skills can be selected by name or loaded dynamically when they match the task.

1. Define one clear outcome, such as a weekly competitor brief or deal strategy.
2. Specify the context to use, instructions to follow, quality checks, and output format.
...
<CardGroup cols={3}>
  ...
  <Card title="Skills and Workflows" icon="wand-magic-sparkles" href="/guides/recipes">
    Author portable skills and schedule recurring prompts.
  </Card>
