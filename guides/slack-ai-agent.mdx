...
### Quick Commands
- `@hindsight competitor analysis [competitor name]`
- `@hindsight deal summary [deal name]`
- `@hindsight battlecard [competitor] vs [your company]`
...
**What you'll see:** The agent will show `Found results in <competitor_name>` followed by sources linking to specific assets, battlecards, and competitive intelligence documents, then an answer.

**What you get:** Direct answers sourced from approved competitive intelligence and analyzed deal outcomes.
...
**What you get:** Key insights, objections, and outcomes from processed deal data.
...
### Leverage Context
- Reference specific deals, competitors, or time periods
- The agent works best with clear, focused requests
- Chain multiple questions to build comprehensive context

### Use for Time-Sensitive Needs
- **Perfect for:** Quick competitor checks before calls
- **Perfect for:** Rapid objection handling during deals
- **Perfect for:** Fast asset generation for proposals

### Know the Limitations
- **For deep analysis:** Use the full in-app chat
- **For raw data exploration:** Access the main platform
- **For custom reporting:** Work with your admin team

## Example Workflows

### Pre-Call Preparation
1. `@hindsight what do I need to know about Competitor X for today's call?`
2. `@hindsight what objections typically come up against Competitor X?`
3. `@hindsight what's our best messaging against Competitor X?`

### Mid-Deal Support
1. `@hindsight how did we handle [specific objection] in similar deals?`
2. `@hindsight create talking points for [specific use case] vs. Competitor Y`
3. `@hindsight what questions should I ask to highlight our strengths?`

### Post-Call Follow-up
1. `@hindsight write a follow-up email addressing [specific concern]`
2. `@hindsight create a comparison sheet for [specific features]`
3. `@hindsight generate a proposal summary highlighting our differentiators`
...
1. **Start conversations in deal-specific channels** — Context helps the agent provide better answers
2. **Use the agent for real-time support** — Perfect for objection handling during live calls
3. **Generate assets on-demand** — Create battlecards and talking points as needed
4. **Chain questions for complex tasks** — Build context across multiple queries
5. **Share outputs with your team** — Generated assets can be saved and reused
